<?php /*a:2:{s:65:"C:\wamp64\www\mpanel\application\mpanel\view\index\node_list.html";i:1553825745;s:60:"C:\wamp64\www\mpanel\application\mpanel\view\index\base.html";i:1553825745;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <script src="/mpanel/public/js/qrcode.min.js"></script>
    <script>
        $(function() {
            <?php if(is_array($nodes) || $nodes instanceof \think\Collection || $nodes instanceof \think\Paginator): $i = 0; $__LIST__ = $nodes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$node): $mod = ($i % 2 );++$i;?>
