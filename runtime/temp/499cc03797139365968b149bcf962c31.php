<?php /*a:3:{s:67:"C:\wamp64\www\mpanel\application\mpanel\view\index\user_manage.html";i:1555570142;s:60:"C:\wamp64\www\mpanel\application\mpanel\view\index\base.html";i:1553825745;s:64:"C:\wamp64\www\mpanel\application\mpanel\view\component\page.html";i:1553825745;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
                            ...
                            <tbody>
                                <?php if(is_array($users) || $users instanceof \think\Collection || $users instanceof \think\Paginator): $i = 0; $__LIST__ = $users;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?>
                                    <tr id="user_<?php echo htmlentities($user['id']); ?>">
                                        ...
                                        <td><?php echo htmlentities(date('Y-m-d H:i',!is_numeric($user['reg_date'])? strtotime($user['reg_date']) : $user['reg_date'])); ?></td>
...
<ul class="uk-pagination uk-flex-right">
    ...
    <?php endif; if(($page - 3) > 1): ?>
        ...
        <?php endif; ?>
    <?php endif; $__FOR_START_4927__=$page - 3;$__FOR_END_4927__=$page;for($i=$__FOR_START_4927__;$i < $__FOR_END_4927__;$i+=1){ if($i > 0): ?>
    ...
    <?php $__FOR_START_4958__=$page + 1;$__FOR_END_4958__=$page + 4;for($i=$__FOR_START_4958__;$i < $__FOR_END_4958__;$i+=1){ if($i <= $count): ?>
            <li><a href="<?php echo url('mpanel/index/user_manage', ['page'=>$i]); ?>"><?php echo htmlentities($i); ?></a></li>
