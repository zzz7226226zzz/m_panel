<?php /*a:2:{s:77:"F:\phpstudy\PHPTutorial\WWW\site\application\mpanel\view\index\node_edit.html";i:1550319943;s:72:"F:\phpstudy\PHPTutorial\WWW\site\application\mpanel\view\index\base.html";i:1550333866;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
            ...
            <div class="uk-card-body">
                <div class="uk-form-horizontal uk-margin-large">
                    <div class="uk-margin">
                        ...
                        <input class="uk-input" type="text" name="name" placeholder="例：美国节点1" id="name" value="<?php echo htmlentities($node['name']); ?>">
                    </div>
                    <div class="uk-margin">
                        ...
                        <input class="uk-input" type="text" name="server" placeholder="域名或ip" id="server" value="<?php echo htmlentities($node['server']); ?>">
                    </div>
                    <div class="uk-margin">
                        ...
                        <input class="uk-input" type="text" name="ip" placeholder="不填则自动获取" id="ip" value="<?php echo htmlentities($node['ip']); ?>">
                    </div>
                    <div class="uk-margin">
                        ...
                        <input class="uk-input" type="text" name="info" placeholder="节点信息描述" id="info" value="<?php echo htmlentities($node['info']); ?>">
                    </div>
                    <div class="uk-margin">
                        ...
                        <div class="uk-form-controls uk-form-controls-text">
                            <label><input class="uk-radio" type="radio" value="1" name="enable" <?php if($node['enable'] == '1'): ?>checked="true"<?php endif; ?>>启用</label><br>
                            <label><input class="uk-radio" type="radio" value="0" name="enable" <?php if($node['enable'] == '0'): ?>checked="true"<?php endif; ?>>关闭</label>
                        </div>
                    </div>
                    <div class="uk-margin">
                        ...
                        <input class="uk-input" type="num" name="traffic_rate" placeholder="用户实际使用流量与服务器统计流量的比例，默认为1" id="traffic_rate" value="<?php echo htmlentities($node['traffic_rate']); ?>">
                    </div>
                    <div class="uk-margin">
                        <label class="uk-form-label" for="form-horizontal-text">节点排序</label><span class="uk-label uk-label-danger" id="sort_label"></span>
                        <input class="uk-input" type="num" name="sort" placeholder="前后台显示顺序，0-99的数字，默认为0" id="sort" value="<?php echo htmlentities($node['sort']); ?>">
                    </div>
    ...
    <script>
        (function () {
            $('#edit').on('click', function() {
                ...
                method: 'POST',
                data: {id: <?php echo htmlentities($node['id']); ?>, name: name, server: server, ip: ip, info: info, enable: enable, traffic_rate: traffic_rate, sort: sort},
                dataType: 'html'
                });
