<?php /*a:3:{s:67:"C:\wamp64\www\mpanel\application\mpanel\view\index\node_manage.html";i:1553825745;s:60:"C:\wamp64\www\mpanel\application\mpanel\view\index\base.html";i:1553825745;s:64:"C:\wamp64\www\mpanel\application\mpanel\view\component\page.html";i:1553825745;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
...
<ul class="uk-pagination uk-flex-right">
    ...
    <?php endif; if(($page - 3) > 1): ?>
        ...
        <?php endif; ?>
    <?php endif; $__FOR_START_25671__=$page - 3;$__FOR_END_25671__=$page;for($i=$__FOR_START_25671__;$i < $__FOR_END_25671__;$i+=1){ if($i > 0): ?>
    ...
    <?php $__FOR_START_25478__=$page + 1;$__FOR_END_25478__=$page + 4;for($i=$__FOR_START_25478__;$i < $__FOR_END_25478__;$i+=1){ if($i <= $count): ?>
            <li><a href="<?php echo url('mpanel/index/node_manage', ['page'=>$i]); ?>"><?php echo htmlentities($i); ?></a></li>
