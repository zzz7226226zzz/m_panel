<?php /*a:3:{s:87:"F:\phpstudy\PHPTutorial\WWW\site\application\mpanel\view\index\announcement_manage.html";i:1551511127;s:72:"F:\phpstudy\PHPTutorial\WWW\site\application\mpanel\view\index\base.html";i:1551511636;s:76:"F:\phpstudy\PHPTutorial\WWW\site\application\mpanel\view\component\page.html";i:1550332029;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <div class="uk-container uk-container-expand">
        <div class="uk-card uk-card-default">
            ...
            <div class="uk-card-body">
                <div>
                    <a class="uk-button uk-button-default" href="<?php echo url('mpanel/index/announcement_add');; ?>">添加节点</a>
                </div>
                <div class="uk-margin"></div>
                            ...
                            <tbody>
                                <?php if(is_array($announcements) || $announcements instanceof \think\Collection || $announcements instanceof \think\Paginator): $i = 0; $__LIST__ = $announcements;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$announcement): $mod = ($i % 2 );++$i;?>
                                    <tr id="announcement_<?php echo htmlentities($announcement['id']); ?>">
                                        ...
                                        <td><?php echo htmlentities($announcement['createtime']); ?></td>
                                    </tr>
...
<ul class="uk-pagination uk-flex-right">
    ...
    <?php endif; if(($page - 3) > 1): ?>
        ...
        <?php endif; ?>
    <?php endif; $__FOR_START_162712482__=$page - 3;$__FOR_END_162712482__=$page;for($i=$__FOR_START_162712482__;$i < $__FOR_END_162712482__;$i+=1){ if($i > 0): ?>
    ...
    <?php $__FOR_START_1421636134__=$page + 1;$__FOR_END_1421636134__=$page + 4;for($i=$__FOR_START_1421636134__;$i < $__FOR_END_1421636134__;$i+=1){ if($i <= $count): ?>
            <li><a href="<?php echo url('mpanel/index/announcement_manage', ['page'=>$i]); ?>"><?php echo htmlentities($i); ?></a></li>
